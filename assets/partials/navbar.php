...
if (isset($_SESSION['user_id'])) {
    ...
    $query = "SELECT id, name, profile_image FROM users WHERE user_id = ?";
    ...
    //"SELECT SUM(quantity) AS total FROM cart_items WHERE cart_id = $cartId"
    $cart_query = "SELECT SUM(quantity) AS totalCartItem 
    FROM cart_items 
    WHERE cart_id = (SELECT cart_id FROM carts WHERE user_id = ?)";
       /*
            SELECT cart_id FROM carts WHERE user_id = $user['id']
            */
    // $sqll = "SELECT SUM(quantity) AS total FROM cart_items WHERE cart_id = 
    //         (SELECT cart_id FROM carts WHERE user_id = $user['id'])";
    ...
    $user = ['name' => 'Guest', 'profile_image' => 'default.png'];
        ...
        <div class="navbar-right ">
            ...
            <ul class="nav navbar-nav">
                ...
                <!-- <ul class="navbar-nav ml-auto"> -->
                    <li class="custom-dropdown">
                        <a class=" custom-dropdown-toggler" href="checkout.php" >
                            <i class="mdi mdi-cart icon"></i>
                            <span class="badge badge-xs rounded-circle" id="totalCartItem"><?php echo $cart['totalCartItem']; ;?></span> <!-- Example badge count -->
                        </a>
                    </li>
                <!-- </ul> -->
                <li class="custom-dropdown">
                ...
                <li class="dropdown user-menu">
                    <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <img src="assets/uploads/profile_photos/<?php echo $user['profile_image'];?>" class="user-image rounded-circle"
                            alt="User Image" />
                        <span class="d-none d-lg-inline-block"><?php echo $user['name'] ?></span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li>
                            <a class="dropdown-link-item" href="user-activities.html">
                                ...
                                <span class="nav-text">Activities</span></a>
                        </li>
                        <li>
                        ...
                        <li class="dropdown-footer">
                            <a class="dropdown-link-item" href="auth.php?logout=1">
