...
$statusCountSql = "SELECT status, COUNT(*) as count FROM borrow_requests GROUP BY status";
                        ...
                        <?php foreach ($requests as $request): ?>
                            <tr>
                                <td data-label="Request ID">
                                    <a href="<?php echo BASE_URL; ?>/borrow/view?id=<?php echo $request['id']; ?>" class="table-request-id">
                                        <i class="fas fa-file-alt"></i>
                                        <?php echo htmlspecialchars($request['request_id']); ?>
                                    </a>
                                </td>
                                <td data-label="Requester"><?php echo htmlspecialchars($request['requester_name']); ?></td>
                                <td data-label="Department"><?php echo htmlspecialchars($request['department_name'] ?? 'Not Set'); ?></td>
                                ...
                                <td data-label="Borrow Date"><?php echo UtilityHelper::formatDateForDisplay($request['borrow_date'], 'short'); ?></td>
                                <td data-label="Return Date"><?php echo UtilityHelper::formatDateForDisplay($request['return_date'], 'short'); ?></td>
                                <td data-label="Status">
                                    ...
                                    switch ($request['status']) {
                                        ...
                                        case 'checked_out':
                                            ...
                                            $statusIcon = 'fas fa-hand-holding';
                                            break;
                                        case 'overdue':
                                    ...
                                    $statusClass = 'badge-' . str_replace('_', '-', $request['status']);
                                    ?>
                                ...
                                <td data-label="Actions">
                                    <div class="action-buttons">
                                        <a href="<?php echo BASE_URL; ?>/borrow/view?id=<?php echo $request['id']; ?>" class="btn btn-sm btn-view" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        
                                        <?php if ($request['status'] === 'pending'): ?>
                                            <button type="button" class="btn btn-sm btn-approve process-btn" data-id="<?php echo $request['id']; ?>" data-action="approve" title="Approve Request">
                                                <i class="fas fa-check"></i>
                                            </button>
                                            <button type="button" class="btn btn-sm btn-reject process-btn" data-id="<?php echo $request['id']; ?>" data-action="reject" title="Reject Request">
                                                <i class="fas fa-times"></i>
                                            </button>
                                        <?php endif; ?>
                                        
                                        <?php if ($request['status'] === 'approved'): ?>
                                            <button type="button" class="btn btn-sm btn-checkout process-btn" data-id="<?php echo $request['id']; ?>" data-action="checkout" title="Check Out Items">
                                                <i class="fas fa-hand-holding"></i>
                                            </button>
                                        <?php endif; ?>
                                        
                                        <?php if ($request['status'] === 'checked_out' || $request['status'] === 'overdue'): ?>
                                            <a href="<?php echo BASE_URL; ?>/borrow/return?id=<?php echo $request['id']; ?>" class="btn btn-sm btn-return" title="Return Items">
                                                <i class="fas fa-undo-alt"></i>
                                            </a>
                                        <?php endif; ?>
                                    </div>
