                    ...
                    <div class="item-card-footer">
                        ...
                        <div class="item-actions">
                            ...
                            <?php if ($item['status'] === 'available'): ?>
                                <a href="<?php echo BASE_URL; ?>/borrow/requestto?id=<?php echo $item['id']; ?>" class="btn btn-sm btn-primary">Request</a>
...
footer {
    ...
    margin-top: auto; /* Push footer to bottom when content doesn't fill page */
}
</style>
